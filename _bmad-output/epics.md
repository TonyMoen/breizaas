...
4. **Kontakt** (Contact): - Email for shipping/return questions - Link to contact form
...
- **Kontaktinformasjon** (Contact Information): - Technical contact person - Day-of-show contact number
...
- **Social Media Links** (Sosiale medier): object with: - Spotify URL - Instagram URL - TikTok URL - Facebook URL - YouTube URL
